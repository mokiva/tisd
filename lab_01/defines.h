...
#define BAD_ROUND             11  // код ошибка, если происходит переполнение округления
#define RES_ORDER_OVERSIZE    12  // код ошибки, если происходит переполнение порядка в ответе
...
#define MAX_ORDER_LEN    6  // знак + 5 значащих цифр порядка
#define MAX_MULTY_LEN   60  // максимальная длина умножения
